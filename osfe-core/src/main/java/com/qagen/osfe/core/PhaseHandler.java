 ...
 * Author: Hycel Taylor
 * <p/>
 * This interface should be implemented by concrete classes that
 * extend the EngineService class and need to load phases differently
 * than the standard PhaseLoaderService class the comes with OSFE.
 */
