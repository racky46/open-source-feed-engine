...
<s:layout-render name="/layout/management_forms.jsp" pageTitle="Feed Group List">
  <s:layout-component name="html-head">
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/scripts/feed_group_list.js"></script>
  </s:layout-component>
  <s:layout-component name="contents">
    <s:messages/>
    <table id="feedGroupList" class="scroll" cellpadding="0" cellspacing="0"></table>
    <div id="pager" class="scroll" style="text-align:center;margin-bottom: 5px;"></div>
    <s:link beanclass="com.qagen.osfe.webapp.web.action.auth.ManageFeedGroupActionBean" event="add">
      <img border="0" align="left" src="${pageContext.request.contextPath}/images/row_add.gif" alt="Add Row" />Add New Feed Group
    </s:link>
