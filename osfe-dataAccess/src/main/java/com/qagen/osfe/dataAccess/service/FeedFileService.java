...
public interface FeedFileService extends Service<FeedFile> {
  public static final String SERVICE_ID = "feedFileService";

  public FeedFile findByPrimaryId(Integer feedFileId);
