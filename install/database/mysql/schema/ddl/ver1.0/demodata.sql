...
--
insert into t_feed (feed_id, activation_date, termination_date, allow_concurrent_runs, allow_failed_state_runs, restart_at_checkpoint, collect_phase_stats, feed_directory, feed_document, max_concurrent_runs, next_sequence_number, from_data_source_id, to_data_source_id, feed_type_id, feed_protocol_id, feed_direction_id, feed_group_id) values ('acme_qagen_testd_request', '2008-01-01 12:00:00', '2009-01-01 12:00:00', '1', '0', '1', '1', 'feed/acme/qagen/testd/request', 'partnerConfig/acme/qagen/testd/request', 1, 0, 'acme', 'qagen', 'testd', 'request', 'inbound', 'test_group');
insert into t_feed (feed_id, activation_date, termination_date, allow_concurrent_runs, allow_failed_state_runs, restart_at_checkpoint, collect_phase_stats, feed_directory, feed_document, max_concurrent_runs, next_sequence_number, from_data_source_id, to_data_source_id, feed_type_id, feed_protocol_id, feed_direction_id, feed_group_id) values ('acme_qagen_testf_request', '2008-01-01 12:00:00', '2009-01-01 12:00:00', '1', '0', '1', '1', 'feed/acme/qagen/testf/request', 'partnerConfig/acme/qagen/testf/request', 1, 0, 'acme', 'qagen', 'testf', 'request', 'inbound', 'test_group');
insert into t_feed (feed_id, activation_date, termination_date, allow_concurrent_runs, allow_failed_state_runs, restart_at_checkpoint, collect_phase_stats, feed_directory, feed_document, max_concurrent_runs, next_sequence_number, from_data_source_id, to_data_source_id, feed_type_id, feed_protocol_id, feed_direction_id, feed_group_id) values ('acme_qagen_testx_request', '2008-01-01 12:00:00', '2009-01-01 12:00:00', '1', '0', '1', '1', 'feed/acme/qagen/testx/request', 'partnerConfig/acme/qagen/testx/request', 1, 0, 'acme', 'qagen', 'testx', 'request', 'inbound', 'test_group');
